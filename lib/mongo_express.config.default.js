...
var mongo = {
  ...
  port: 27017,
  ssl: false,
  url: URI || 'mongodb://localhost:27017/proctest',
  username: 'admin',
};
...
var { MONGODB_CONNECTION, MONGODB_INSTANCE_NAME, MONGODB_PORT_27017_TCP_ADDR, MONGODB_PORT_27017_TCP_PORT, MONGODB_PASSWORD, MONGODB_USERNAME } = process.env
...
if (process.env.VCAP_SERVICES) {
  ...
  mongo = {
    db:       MONGODB_INSTANCE_NAME || 'proctest',
    host:     MONGODB_PORT_27017_TCP_ADDR || 'localhost',
    password: MONGODB_PASSWORD || 'pass',
    port:     MONGODB_PORT_27017_TCP_PORT || 27017,
    ssl:      false,
    url:      MONGODB_CONNECTION || 'mongodb://localhost:27017/proctest',
...
>>>>>>> 5ac8705abdf032f1b1eb0b52ffa1d49e8022e0e2
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'mongo',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'mongoadmin',
  },
